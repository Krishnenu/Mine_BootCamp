  ...
  const onSubmitHandler = (e) => {
    ...
    if (input.email && input.password) {
      fetch("https://reqres.in/api/login", {
        ...
        .then((res) => {
          if (res.status === 200) {
            console.log("api fetch succesfull");
        ...
        .finally(() => setInputData({ email: "", password: "" }));
    }
  };
  const setEmailHandler = (event) => {
    setInputData({ ...input, [event.target.name]: event.target.value });
          ...
          <form onSubmit={onSubmitHandler}>
            ...
            <div className="from_Section">
              ...
              <input
                ...
                className="password"
              />
              <div className="declration_Section">
                <input type="checkbox" className="declration_content" />
                <p className="declration_content">
                  By creating or logging into my account you are agreeing with
                  our
